...
const foodSeeds = [
  'restaurants near me', 'whats open now', 'late night food in', 'what to eat for lunch', 'what should I eat', 'Where to eat', 'best breakfast in', 'breakfast near me', 'lunch near me', 'chinese food near me', 'best sushi place', 'tim hortons', 'Boston Pizza', 'closest mcdonald\'s', 'all you can eat', 'sushi', 'chinese food', 'japanese food', 'korean food', 'indian food', 'kimchi fried rice', 'fried rice', 'dim sum near me', 'dim sum around me', 'good dim sum near me', 'good dim sum around me', 'good sushi near me', 'good sushi around me',' where to eat', 'cheesecake', 'cake', 'donut', 'shaved ice', 'bubble tea', 'tea', 'pho', 'coffee', 'bakery', 'baked good', 'pizza factory', 'spaghetti factory', 'meat ball spaghetti', 'spaghetti', 'best cheesecake', 'mac and cheese', 'delicious', 'delicious food', 'vegan food', 'vegan', 'vegan burger', 'beyond meat', 'beyond meat burger', 'fast food', 'shitty food', 'junk food', 'fonde', 'chicken', 'almond chicken', 'spicy pork', 'pork belly', 'healthy food', 'healthy restaurant', 'tofu', 'protein', 'smoothie', 'protein shakes', 'smoothie shakes', 'orange', 'orange juice', 'apple', 'apple juice', 'coconut juice', 'coconut water', 'water', 'drinks', 'beers', 'alochol', 'cuisine', 'japadog', 'thai', 'dessert', 'earls', 'earl\'s', 'white spot', 'pub', 'club', 'browns', 'taco', 'a&w', 'organic', 'papa john', 'bread', 'soup'
];
